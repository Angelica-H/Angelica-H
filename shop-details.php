                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="img/product/<?php echo $product['product_image']; ?>">
                                </div>
                            </a>
                        </li>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <h3>$<?php echo number_format($product['price'], 2); ?> <span>$<?php echo number_format($product['sale_price'], 2); ?></span></h3>
                        <p><?php echo $product['description']; ?></p>
                        <div class="product__details__option">
                            <div class="product__details__option__size">
                                <span>Size:</span>
                                <label for="xxl">
                                    <input type="radio" id="xxl"> XXL
                                </label>
                                <label class="active" for="xl">
                                    <input type="radio" id="xl"> XL
                                </label>
                                <label for="l">
                                    <input type="radio" id="l"> L
                                </label>
                                <label for="sm">
                                    <input type="radio" id="sm"> S
                                </label>
                            </div>
                            <div class="product__details__option__color">
                                <span>Color:</span>
                                <label class="c-1" for="sp-1">
                                    <input type="radio" id="sp-1"> Red
                                </label>
                                <label class="c-2" for="sp-2">
                                    <input type="radio" id="sp-2"> Blue
                                </label>
                                <label class="c-3" for="sp-3">
                                    <input type="radio" id="sp-3"> Green
                                </label>
                            </div>
                        </div>
                        <div class="product__details__cart__option">
                            ...
                            <a href="cart.php?product_id=<?php echo $product['product_id']; ?>" class="primary-btn">Thêm vào giỏ</a>
                        </div>
