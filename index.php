                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/product/<?php echo $row['product_image']; ?>">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="shop-details.php?id=<?php echo $row['product_id']; ?>"><img src="img/icon/search.png" alt=""></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            ...
                            <a href="javascript:void(0)" class="add-cart" 
                               ...
                               onclick="addToCart('<?php echo $row['product_id']; ?>','<?php echo addslashes($row['product_name']); ?>',<?php echo $row['price']; ?>, 1)">+ Thêm vào giỏ hàng</a>
                            <div class="rating">
...
<!--- <script>
    $(document).ready(function(){
        // Bắt sự kiện khi nhấn nút "Add to Cart"
        $('.add-cart').on('click', function() {
            var product_id = $(this).data('product-id');

            $.ajax({
                url: 'cart/cart.php', // Đường dẫn đến file PHP xử lý
                type: 'POST',
                data: {
                ...
                success: function(response) {
                    ...
                    // Có thể cập nhật số lượng giỏ hàng trên header mà không cần tải lại trang
